...
const HeaderAdmin = () => {
    ...
    return (
        <Navbar className="bg-body-tertiary d-flex flex-row flex-wrap border-bottom m-0 p-0" style={{maxWidth:'100vw'}}>
            ...
            <Container className='m-0'>
                ...
                <Button variant="primary" className='align-self-end m-0' onClick={logout}>
                    Deconnexion
                </Button>
                </Navbar.Collapse>
            </Container>
