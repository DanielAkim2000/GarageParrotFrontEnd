...
const VoituresShow = () => {
  ...
  return (
    <div className="d-flex flex-row justify-content-center align-items-center w-100 flex-wrap">
      <Card style={{minHeight:'100px',minWidth:'200px'}} className="bg-dark text-white m-3 w-25 h-25 w-sm-100 h-sm-100">
      <Card.Img className="w-100 h-100" src={voiture.image} alt="Card image" />
      <Card.ImgOverlay>
    ...
    <ListGroup className="m-3">
      ...
      <ListGroup.Item>Année: {voiture.annee_mise_en_circulation}</ListGroup.Item>
      <ListGroup.Item>Kilométrage: {voiture.kilometrage}Km</ListGroup.Item>
      <ListGroup.Item><ModalContact data={voiture} /></ListGroup.Item>
    </ListGroup>
    </div>
  );
};
