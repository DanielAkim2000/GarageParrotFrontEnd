...
const NousContacter = (props) => {
  ...
  return (
    <Form>
      <label style={{ gridArea: "label1" }} htmlFor="nom">
        Nom:
      </label>
      <input
        onChange={(e) => {
        ...
        id="nom"
      />
      <label style={{ gridArea: "label2" }} htmlFor="prenom">
        Prenom:
      </label>
      <input
        onChange={(e) => {
        ...
        id="prenom"
      />
      <label style={{ gridArea: "label3" }} htmlFor="email">
        Email:
      </label>
      <input
        onChange={(e) => {
        ...
        id="email"
      />
      <label style={{ gridArea: "label4" }} htmlFor="tel">
        Tel:
      </label>
      <input
        onChange={(e) => {
        ...
        id="tel"
      />
      <label style={{ gridArea: "label5" }} htmlFor="sujet">
        Sujet:
      </label>
      <input
        onChange={(e) => {
        ...
        id="sujet"
      />
      <label style={{ gridArea: "label6" }} htmlFor="message">
        Message:
      </label>
      <textarea
        onChange={(e) => {
